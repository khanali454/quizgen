...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  // close sidebar on clicking outside -  mobile and tablet view
  useEffect(() => {
    ...
    // on clicking anywhere in the document
    document.addEventListener('click', clickHandler);
    // removing listner for the document
    return () => document.removeEventListener('click', clickHandler);
  });

  // close the sidebar if the esc key is pressed - mobile and tablet view
  useEffect(() => {
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <NavLink to="/">
          ...
          <b className="text-bold text-white text-xl">Tutor Sowlf</b>
        </NavLink>
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                ...
                >
                  <svg width="18"
                    height="18" fill="currentColor" className="bi bi-people" viewBox="0 0 16 16">
              ...
              <li>
                ...
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="18"
                    height="18" fill="currentColor" className="bi bi-boxes" viewBox="0 0 16 16">
              ...
              <li>
                ...
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" className="bi bi-wallet2" viewBox="0 0 16 16">
              ...
              <li>
                <Link
                  to='/invoices'
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('invoices') && 'bg-graydark dark:bg-meta-4'}`}
                >
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" className="bi bi-receipt" viewBox="0 0 16 16">
