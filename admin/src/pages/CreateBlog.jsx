...
import { FaUpload } from 'react-icons/fa'; // To use an upload icon for image input
...
const CreateBlog = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // Form submission logic here (e.g., save blog data)
    const blogData = {
      id: Date.now(), // Simple id generation based on timestamp
      title,
      feature_image: imagePreview || "https://via.placeholder.com/800x400", // Default placeholder if no image is uploaded
      content,
    };
