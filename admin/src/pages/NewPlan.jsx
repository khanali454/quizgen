...
const NewPlan = () => {
    ...
    const handleSubmit = (e) => {
        ...
        axios.post(`${import.meta.env.VITE_API_BASE_URL}/admin/plans`, planData, {
            headers: {
                        ...
                        <form onSubmit={handleSubmit}>
                            <div className="p-6.5">
                                ...
                                <button className="flex w-full justify-center rounded bg-primary p-3 font-medium text-gray hover:bg-opacity-90">
                                    ...
                                    {processing ?(<div className='flex items-center justify-center'><Processor borderColorValue='white' widthValue={4} heightValue={4} /> <span className="ml-2">Create Plan</span> </div>) : (
                                        <>Create Plan</>
                                    )}
                                </button>
                            </div>
