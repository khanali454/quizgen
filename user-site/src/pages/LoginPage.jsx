        ...
        <div className="relative flex flex-col sm:w-[30rem] rounded-lg border border-gray-400 bg-white shadow-lg px-4">
          <div className="flex-auto p-6">
            ...
            <form className="mb-4">
              ...
              <button onClick={()=>{navigate('/dashboard')}} className="w-full rounded-md border border-indigo-500 bg-gradient-to-r from-blue-500 to-purple-500 py-2 px-5 text-white shadow hover:bg-indigo-600">
                Sign in
              </button>
            </form>
